        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
            <tr class="info">
              ...
              <th style="text-align: center;">Bug Title</th>
              <th style="text-align: center;">Author</th>
              <th style="text-align: center;">Bug Category</th>
            ...
            <tr class="success">
             ...
             ?>
              ...
              <?php
                ...
                {
               ?>
              <td style="text-align: center;"><span class="label label-success">Normal Proprity</span></td>
              <?php
                }
                else
                {
              ?>
              <td style="text-align: center;"><span class="label label-warning">Highly Priority</span></td>
              <?php
                }
              ?>
              <td style="text-align: center;">
