                ...
                ?>
                  <tbody id="myTable">
                    <tr class="success">
                      ...
                      ?>
                        <td style="text-align: center;"><span class="label label-primary">Management</span></td>

                      <?php
                      } else {
                      ?>
                        <td style="text-align: center;"><span class="label label-primary">Developer</span></td>
