          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body" id="demo" onmouseover="mouseOver(this)">
                ...
                <div class="form-group">
                  <label for="post_title_edit" class="col-form-label">Bug Title:</label>
...
//}
                  ...
                  <div class="row">
                  <div class="col-sm-4">
                    <label for="post_status_edit1" class="col-form-label" >Priority:</label><br>
                    <input type="radio" name="post_status_edit" value="1" checked=""> Normal Prioity
                    <input type="radio" name="post_status_edit" value="0"> Highly Prioity
                  </div>
                  <div class="col-sm-2">
                    <label for="post_priority_edit" class="col-form-label">Priority No:</label>
