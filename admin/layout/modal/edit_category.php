          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="cat_title_edit" class="col-form-label">Bug Title:</label>
                  <input type="text" class="form-control" id="cat_title_edit" name="cat_title_edit" placeholder="Enter Bug Title Here" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="cat_slug_edit" class="col-form-label">Servity:</label>
                  <input type="text" class="form-control" id="cat_slug_edit" name="cat_slug_edit" placeholder="Enter Servity Here" required="">
                </div>
                <div class="col-sm-4">
                    <label for="cat_status_edit" class="col-form-label" >Priority:</label><br>
                    <input type="radio" name="cat_status_edit" id="cat_status_edit" value="1" checked=""> Normal Priority
                    <input type="radio" name="cat_status_edit" id="cat_status_edit" value="0"> Highly Priority
                  </div>
