          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header modal-header-add">
                <h4 class="modal-title" id="exampleModalLongTitle" align="center"><i class="fa fa-server"></i> Add new Bug category</h4>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="cat_title" class="col-form-label">Bug Category:</label>
                  <input type="text" class="form-control" id="cat_title" name="cat_title" placeholder="Enter Bug Category Here" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="cat_slug" class="col-form-label">Bug Severity:</label>
                  <input type="text" class="form-control" id="cat_slug" name="cat_slug" placeholder="Enter Bug Severity Here" required="">
                </div>
                <div class="form-group col-md-6">
                    <label for="cat_status" class="col-form-label" >Priority:</label><br>
                    <input type="radio" name="cat_status" id="cat_status" value="1" checked=""> Normal Priority
                    <input type="radio" name="cat_status" id="cat_status" value="0"> Highly Prioity
                </div>
                <div class="form-group col-md-6">
