          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header modal-header-add">
                <h4 class="modal-title" id="exampleModalLongTitle" align="center"><i class="fa fa-file"></i> Add new Bug-Report</h4>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="post_title" class="col-form-label">Bug Title:</label>
...
//function myFunction() {
  //alert("Hello! I am an alert box!");
                ...
                <div class="row">
                    <div class="col-sm-4">
                      <label for="category_id" class="col-form-label">Bug Category:</label>
                  ...
                  <div class="col-sm-4">
                    <label for="post_status" class="col-form-label" >Priority:</label><br>
                    <input type="radio" name="post_status" id="post_status" value="1" checked=""> Normal Priority
                    <input type="radio" name="post_status" id="post_status" value="0"> Highly Priority
                  </div>
                  <div class="col-sm-2">
                    <label for="post_priority" class="col-form-label">Priority No:</label>
