        ...
        <div class="box-body">
          ...
          <table class="table table-hover">
            <tr class="info">
              ...
              <th style="text-align: center;">Servity</th>
            ...
            <tr class="success">
             ...
             ?>
              ...
              <?php
                ...
                {
               ?>
              <td style="text-align: center;"><span class="label label-success">Normal Prioity</span></td>
              <?php
                }
                else
                {
              ?>
              <td style="text-align: center;"><span class="label label-warning">Highly Prioity</span></td>
              <?php
                }
              ?>
              <td style="text-align: center;">
